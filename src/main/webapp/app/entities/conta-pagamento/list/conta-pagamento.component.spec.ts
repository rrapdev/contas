...
describe('ContaPagamento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'conta-pagamento', component: ContaPagamentoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contaPagamentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to contaPagamentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContaPagamentoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContaPagamentoIdentifier).toHaveBeenCalledWith(entity);
